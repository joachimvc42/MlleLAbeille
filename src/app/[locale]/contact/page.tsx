...
export default async function ContactPage({
  ...
  return (
    <div className="mx-auto max-w-[700px] px-6 py-16 sm:px-10">
      <h1 data-cms={`contact-title-${locale}`} className="text-center text-4xl font-semibold text-rose">
        {dict.contact.title}
      </h1>
      <p data-cms={`contact-intro-${locale}`} className="mt-4 text-center leading-relaxed">{dict.contact.intro}</p>
